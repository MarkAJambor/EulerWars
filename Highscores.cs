...
public class Highscores : MonoBehaviour
{
    ...
    const string privateCode = "jvxAUTGJmEKyTx61FlRY2gJPJzMwJc9EyJVBze8BsCMQ";
    const string publicCode = "5c68807f3994ab0f6c09d341";
    ...
    IEnumerator UploadNewHighscore(float skill, string playerName, string ship)
    {
        ...
        WWW www = new WWW(webURL + privateCode + "/add/" + WWW.EscapeURL(playerName) + "/" + WWW.EscapeURL(skill.ToString()) + "/" + (this.stringToInt(playerName) + this.encryption(skill, playerName)).ToString() + "/" + WWW.EscapeURL(ship));
